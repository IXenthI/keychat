...
- The emote picker also includes your **Twitch emotes** (global + sub emotes from every channel you're subscribed to) once you grant the `user:read:emotes` permission (`/logout` and sign in again)
